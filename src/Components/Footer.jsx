            ...
            <div className="row">
                <div className="col-lg-12">
                    <div className="position-relative newsletter-inner">
                        ...
                        <img src="assets/imgs/banner.png" alt="letter" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <div className="row">
        <div className="col">
            <div className="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                <div className="logo mb-30">
                    <a href="/" className="mb-15"><img src="assets/imgs/theme/logo.svg" alt="logo" /></a>
        ...
        <div className="footer-link-widget widget-install-app col wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
            ...
            <div className="download-app">
                <a href="#" className="hover-up mb-sm-2 mb-lg-0"><img className="active" src="src/  assets/imgs/theme/app-store.jpg" alt="" /></a>
                <a href="#" className="hover-up mb-sm-2"><img src="src/assets/imgs/theme/google-play.jpg" alt="" /></a>
            </div>
            <p className="mb-20">Secured Payment Gateways</p>
            <img className="" src="src/assets/imgs/theme/payment-method.png" alt="" />
        </div>
    </div>
</section>
            ...
            <div className="row align-items-center">
                ...
                <div className="col-xl-4 xcol-lg-6 text-center d-none d-xl-block">
                    <div className="hotline d-lg-inline-flex">
                        <img src="src/assets/imgs/theme/icons/phone-call.svg" alt="hotline" />
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 text-end d-none d-md-block">
                    <div className="mobile-social-icon">
                        <h6>Follow Us</h6>
                        <a href="#"><img src="src/assets/imgs/theme/icons/icon-facebook-white.svg" alt="" /></a>
                        <a href="#"><img src="src/assets/imgs/theme/icons/icon-twitter-white.svg" alt="" /></a>
                        <a href="#"><img src="src/assets/imgs/theme/icons/icon-instagram-white.svg" alt="" /></a>
                        <a href="#"><img src="src/assets/imgs/theme/icons/icon-pinterest-white.svg" alt="" /></a>
                        <a href="#"><img src="src/assets/imgs/theme/icons/icon-youtube-white.svg" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
